...
# by nested shells. fpath is deliberately left unexported (no FPATH here): it
# includes zsh's version-pinned functions dir, which a brew zsh upgrade would
# turn stale in any child that inherited an exported copy.
